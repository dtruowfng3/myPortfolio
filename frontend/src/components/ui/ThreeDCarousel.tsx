...
/* 1️⃣  Assets ————————————————————————— */
import springImg from '../../assets/carousel/spring.jpg';
import summerImg from '../../assets/carousel/summer.jpg';
import thunderstormImg from '../../assets/carousel/thunderstorm.jpg';
import autumnImg from '../../assets/carousel/autunm.jpg';
import winterImg from '../../assets/carousel/winter.jpg';
import thunderstorm2Img from '../../assets/carousel/thunderstorm_2.jpg';
